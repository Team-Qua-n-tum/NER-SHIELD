...
export const AdminDashboard = () => {
  ...
  return (
    <div className={`min-h-screen bg-slate-950 text-slate-100 flex flex-col ${emergencyMode ? 'ring-2 ring-red-500/50' : ''}`}>
      ...
      {/* Main Workspace with Sidebar + Center Work Area */}
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-slate-900/60 p-4 rounded-2xl border border-slate-800">
            <div>
              <h1 className="text-xl sm:text-2xl font-black text-white tracking-tight flex items-center gap-2">
                ...
                NER Regional Logistics Command Center
              </h1>
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                <span>Log Field Disruption</span>
              </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard
              ...
              subvalue={`/ ${vehicles.length} Total`}
              change={`${delayedVehiclesCount} delayed/caution`}
            ...
            <StatCard
              title="Disaster & Road Hazards"
              value={alerts.length}
              subvalue="Active Feeds"
              change={`${criticalIncidentsCount} High Priority`}
              trend="down"
              icon={AlertTriangle}
              colorScheme="red"
              badge="BRO / EOC"
            ...
            <StatCard
              ...
              value="98.2%"
              subvalue="AI Efficiency"
              change="+1.8% vs Last Shift"
              trend="up"
              icon={Compass}
              colorScheme="emerald"
              badge="NH-27 Optimal"
