...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="px-4 py-1.5 rounded-xl text-sm font-semibold text-white bg-blue-600 hover:bg-blue-500 transition-colors"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Link
              ...
              className="group flex items-center gap-2.5 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-sm shadow-xl shadow-blue-900/30 transition-all w-full sm:w-auto justify-center"
            >
            ...
            <Link
              ...
              className="group flex items-center gap-2.5 px-6 py-3.5 rounded-2xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white font-bold text-sm transition-all w-full sm:w-auto justify-center"
            >
      ...
      {/* ── Static Stats ──────────────────────────────────────────────────── */}
      <section className="py-8 border-y border-slate-800/60 bg-slate-900/30">
              ...
              return (
                ...
                >
                  <div className={`flex items-center gap-2 mb-3`}>
                    ...
                    <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${card.border} ${card.text} bg-slate-900/40`}>
                      {card.badge}
                    </span>
                  </div>
      ...
      <section className="py-16 px-4 bg-slate-900/30 border-y border-slate-800/60">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-black text-white mb-2">Choose Your Portal</h2>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <Link
              to="/login?portal=ops"
              className="group p-6 rounded-3xl bg-slate-900 border border-slate-800 hover:border-blue-500/40 transition-all hover:shadow-xl hover:shadow-blue-900/20"
            >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {['Admin', 'District Officer', 'Logistics Operator'].map(r => (
                      <span key={r} className="text-[10px] font-medium px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400">{r}</span>
                    ))}
                  </div>
                </div>
                <ArrowRight className="w-5 h-5 text-slate-600 group-hover:text-blue-400 transition-colors mt-1 shrink-0" />
              </div>
            </Link>
            ...
            <Link
              to="/login?portal=field"
              className="group p-6 rounded-3xl bg-slate-900 border border-slate-800 hover:border-emerald-500/40 transition-all hover:shadow-xl hover:shadow-emerald-900/20"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {['Field Officer', 'Patrol'].map(r => (
                      <span key={r} className="text-[10px] font-medium px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400">{r}</span>
                    ))}
                  </div>
                </div>
                <ArrowRight className="w-5 h-5 text-slate-600 group-hover:text-emerald-400 transition-colors mt-1 shrink-0" />
              </div>
            </Link>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="p-5 rounded-2xl bg-slate-900/50 border border-slate-800 flex gap-4">
            ...
            <div className="space-y-1.5">
              <h4 className="text-xs font-bold text-slate-300">Security &amp; Privacy</h4>
      ...
      <footer className="border-t border-slate-800 py-6 px-4 text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="text-xs font-bold text-slate-500 tracking-wider">NER-SHIELD</span>
        </div>
