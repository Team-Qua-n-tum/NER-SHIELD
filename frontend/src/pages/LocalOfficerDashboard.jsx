        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className="bg-gradient-to-r from-amber-950/40 via-slate-900 to-slate-900 p-4 sm:p-5 rounded-2xl border border-amber-500/30 shadow-xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center space-x-3.5">
              <div className="w-12 h-12 rounded-2xl bg-amber-500/20 border border-amber-500/40 p-2 flex items-center justify-center text-amber-400">
                <MapPin className="w-6 h-6" />
              </div>
              <div>
                <div className="flex items-center space-x-2">
                  <span className="text-xs font-bold text-amber-400 uppercase tracking-wider font-mono">
                    Jurisdiction Sector: Assam & Dima Hasao Hill Sector
                  </span>
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                <span>Log New Field Hazard</span>
              </button>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard
              ...
              change={unverifiedIncidents.length > 0 ? "Requires on-site confirmation" : "All verified"}
            ...
            <StatCard
              title="Verified Active Incidents"
              value={verifiedIncidents.length}
              subvalue="Clearance Operations"
              change="BRO & SDRF Teams Active"
              trend="up"
              icon={CheckCircle2}
              colorScheme="blue"
            ...
            <StatCard
              title="District Connectivity"
              value="8 / 8"
              subvalue="NER States Tracked"
              change="Dima Hasao Pass Bottleneck"
              trend="neutral"
              icon={Activity}
              colorScheme="emerald"
