...
export const Login = () => {
  ...
  const roles = [
    ...
    },
    {
      ...
      demoUser: 'Inspector Debajit Barman (Kamrup)'
    },
    {
      id: 'supply',
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden text-slate-100">
      ...
      <div className="absolute bottom-0 right-10 w-[500px] h-[300px] bg-cyan-600/10 blur-[140px] pointer-events-none rounded-full" />

      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3 relative z-10">
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-cyan-400 p-0.5 shadow-xl shadow-blue-500/20">
        ...
        <p className="text-xs text-slate-400">
          AI Smart Logistics & Disaster Resilience Platform for the North Eastern Region
        </p>
      </div>

      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-2xl relative z-10">
        <div className="bg-slate-900/90 py-8 px-6 sm:px-10 rounded-3xl border border-slate-800 shadow-2xl backdrop-blur-md space-y-6">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-3 pt-2 border-t border-slate-800/80 flex items-center justify-between text-[10px] text-slate-400 font-mono">
                      ...
                      <span className="text-cyan-400 font-sans">User: {role.demoUser.split(' ')[0]}</span>
                    </div>
                  </div>
                );
              })}
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-4 pt-2">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-slate-950 border border-slate-700 text-sm text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 font-mono"
                  required
                />
              </div>
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="text-cyan-400 font-mono text-[11px]">NER-AUTH-V2</span>
            </div>

            <button
              type="submit"
              className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white font-bold text-sm shadow-xl shadow-blue-500/20 flex items-center justify-center space-x-2 transition-all hover:scale-[1.01]"
            >
          ...
          <div className="pt-4 border-t border-slate-800">
            <p className="text-[11px] font-semibold text-slate-400 mb-2.5 text-center">
              Quick 1-Click Role Portals:
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
              <button
                type="button"
                onClick={() => handleQuickLogin('admin')}
                className="px-3 py-2 rounded-xl bg-slate-950 hover:bg-indigo-950/50 border border-slate-800 hover:border-indigo-500/40 text-indigo-300 font-medium transition-colors text-center"
              >
                ⚡ Admin
              </button>
              <button
                ...
                className="px-3 py-2 rounded-xl bg-slate-950 hover:bg-emerald-950/50 border border-slate-800 hover:border-emerald-500/40 text-emerald-300 font-medium transition-colors text-center"
              >
                ⚡ Driver
              </button>
              <button
                ...
                className="px-3 py-2 rounded-xl bg-slate-950 hover:bg-amber-950/50 border border-slate-800 hover:border-amber-500/40 text-amber-300 font-medium transition-colors text-center"
              >
                ⚡ Local Officer
              </button>
              <button
                ...
                className="px-3 py-2 rounded-xl bg-slate-950 hover:bg-cyan-950/50 border border-slate-800 hover:border-cyan-500/40 text-cyan-300 font-medium transition-colors text-center"
              >
                ⚡ Supply Dept
              </button>
            </div>
